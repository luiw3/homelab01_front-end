...
const Navigation = () => {
    return (
        <nav className="flex flex-row flex-wrap justify-between h-full border-r border-black">
            <NavLink to="/" className={({ isActive }) => (isActive ? "bg-zinc-800 text-white" : "text-blue-900") + ' basis-full group rounded-tl-lg'} >
            ...
            <NavLink to="expenses" className={({ isActive }) => (isActive ? "bg-zinc-800 text-white" : "text-blue-900") + ' basis-full group '}>
            ...
            <NavLink to="goals" className={({ isActive }) => (isActive ? "bg-zinc-800 text-white" : "text-blue-900") + ' basis-full group rounded-bl-lg'}>
